...
@RequestMapping(APIPath.API + APIPath.STATUS_RESERVATION)
public class StatusReservController {

    @Autowired
    private StatusService statusService;

    @GetMapping
    public ResponseEntity<List<StatusReservation>> getAllStatusReserv() {
        List<StatusReservation> statusReservationList = statusService.getAll();
        return ResponseEntity.ok(statusReservationList);
    }
}
